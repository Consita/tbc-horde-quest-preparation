...
local questsMetadata = {
	...
	[8361] = { name="Abyssal Contacts", baseexp=9550, qlvl=60, type="turnin", reqItems="20513-1", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8332] = { name="Dukes of the Council", baseexp=9550, qlvl=60, type="turnin", reqItems="20513-3,14344-1", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	...
	[8348] = { name="Signet of the Dukes", baseexp=11900, qlvl=60, type="turnin", reqItems="20514-1", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	...
	[8331] = { name="Aurel Goldleaf", baseexp=960, qlvl=60, type="turnin", routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8343] = { name="Goldleaf's Discovery", baseexp=960, qlvl=60, type="turnin", routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8349] = { name="Bor WIldmane", baseexp=960, qlvl=60, type="turnin", routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8351] = { name="Bor Wishes to Speak", baseexp=960, qlvl=60, type="turnin", routes="Main,Strat,Solo", routePickup="SilithusHold2", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	...
	[5527] = { name="A Reliquary of Purity", baseexp=9550, qlvl=60, type="optional", routes="Main,Strat,Solo", routeSection="Moonglade", areaType="Zone", area="Moonglade", },
	...
	[2938] = { name="Venom to the Undercity", baseexp=12250, qlvl=55, type="turnin", preQuests="2933,2934,2935,2936", routes="Main,Strat,Solo", routePickup="AV", routeSection="Undercity", areaType="Zone", area="Undercity", },
	...
	[7441] = { name="Pusillin and the Elder Azj'Tordin", baseexp=13500, qlvl=58, type="optional", routes="Solo", routeSection="Feralas", areaType="Dungeon", area="Dire Maul", comments="This quest requires too much running for the little ext boost, but if you need it as optional, It's turned in north of Camp Mojache" },
	...
	[4903] = { name="Warlord's Command", baseexp=14300, qlvl=60, type="optional", routes="Main,Strat,Solo", routeSection="Badlands", areaType="Dungeon", area="Lower Blackrock Spire", comments="This quest is part of the Onyxia Attunement. The Onyxia head is better exp, as it unlocks 2x 14300 exp quests, but if you don't plan on getting it, use this quest!" },
