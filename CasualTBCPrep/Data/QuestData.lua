...
local questsMetadata = {
	...
	[8308] = { name="Brann Bronzebeard's Lost Letter", baseexp=11900, qlvl=60, type="turnin", reqItems="20460-1", routes="Main,Strat,Solo", routePickup="SilithusSouth", routeSection="SilithusSouth", areaType="Zone", area="Silithus", },
