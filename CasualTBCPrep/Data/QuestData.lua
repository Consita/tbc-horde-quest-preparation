...
local questsMetadata = {
	...
	[7142] = { id=7142, name="The Battle for Alterac", baseexp=0, exp=0, qlvl=51, type="qlog", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="Added in 3.15. Battleground Quest Scaling was tested on PTR. This quest is 14.3k at 60, 14.7k at 61 and 15k at 62, making it the quest with the most exp in the game right now" },
	[8272] = { id=8272, name="Hero of the Frostwolf", baseexp=0, exp=0, qlvl=51, type="turnin", routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15. Battleground Quest Scaling was tested on PTR. The XP value shown depends on what level your character is when turning it in." },
	[7101] = { id=7101, name="Towers and Bunkers", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15. Battleground Quest Scaling was tested on PTR. The XP value shown depends on what level your character is when turning it in." },
	[7124] = { id=7124, name="Capture a Mine", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15. Battleground Quest Scaling was tested on PTR. The XP value shown depends on what level your character is when turning it in." },
	[7082] = { id=7082, name="The Graveyards of Alterac", baseexp=0, exp=0, qlvl=51, type="optional", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="Added in 3.15. Battleground Quest Scaling was tested on PTR. The XP value shown depends on what level your character is when turning it in." },
