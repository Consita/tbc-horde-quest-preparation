...
local questsMetadata = {
	...
	[7649] = { name="Enchanted Thorium Platemail: Volume I", baseexp=14300, qlvl=60, type="disabled", reqItems="18769-1", reqProf=164, reqProfSkill=300, routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7650] = { name="Enchanted Thorium Platemail: Volume II", baseexp=14300, qlvl=60, type="disabled", reqItems="18770-1", reqProf=164, reqProfSkill=300, routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
	[7651] = { name="Enchanted Thorium Platemail: Volume III", baseexp=14300, qlvl=60, type="disabled", reqItems="18771-1", reqProf=164, reqProfSkill=300, routes="Main,Strat,Solo", routeSection="felwoodTown", areaType="Dungeon", area="Dire Maul", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. Our RXP turnin guide will NOT turn in this quest, you MUST plan this yourself" },
