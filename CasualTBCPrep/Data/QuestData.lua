...
local questsMetadata = {
	...
	[7163] = { name="Rise and Be Recognized", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1", preQuests="7161", reqRep=729, reqRepRank=5, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
