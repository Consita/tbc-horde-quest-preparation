...
local questsMetadata = {
	...
	[8318] = { id=8318, name="Secret Communication", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20404-10", routes="Main,Strat,Solo", routeSection="SilithusHold", areaType="Zone", area="Silithus", },
	...
	[7163] = { id=7163, name="Rise and Be Recognized", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7164] = { id=7164, name="Honored Amongst the Clan", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7165] = { id=7165, name="Earned Reverence", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=2, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7166] = { id=7166, name="Legendary Heroes", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7167] = { id=7167, name="Eye of Command", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	...
	[8316] = { id=8316, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="WARRIOR", routes="Main,Strat", routeSection="SilithusHold", areaType="Zone", area="Silithus", comments="Requires doing \"The Calling\" on TBC release" },
	[8376] = { id=8376, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="PALADIN", routes="Main,Strat", routeSection="SilithusHold", areaType="Zone", area="Silithus", },
	[8377] = { id=8377, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="HUNTER", routes="Main,Strat", routeSection="SilithusHold", areaType="Zone", area="Silithus", },
	[8380] = { id=8380, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="SHAMAN", routes="Main,Strat", routeSection="SilithusHold", areaType="Zone", area="Silithus", },
	[8382] = { id=8382, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="DRUID", routes="Main,Strat", routeSection="SilithusHold", areaType="Zone", area="Silithus", },
