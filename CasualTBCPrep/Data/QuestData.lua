...
local questsMetadata = {
	...
	[8430] = { id=8430, name="Battle of Warsong Gulch", baseexp=9550, exp=0, qlvl=60, type="disabled", reqItems="20558-3", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. It is included in the Turnin RXP Guide." },
	[8439] = { id=8439, name="Conquering Arathi Basin", baseexp=9550, exp=0, qlvl=60, type="disabled", reqItems="20559-3", routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", comments="This quest was added from the EXTRAS tab, ROUTING IS NOT SUPPORTED. It is included in the Turnin RXP Guide." },
