...
local questsMetadata = {
	...
	[9232] = { id=9232, name="The Only Song I Know...", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="22682-2,7080-2,12361-2", preQuests="9033", routes="Main,Strat,Solo", routePickup="EPLTown", routeSection="EPLTown", areaType="Raid", area="Naxxramas", comments="Requires Raiding Naxxramas. Is not included in the RXP guides" },
	...
	[8947] = { id=8947, name="Anthion's Strange Request", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8920,8923,8921,8924,8925", routes="Strat", routePickup="StratholmeGates2", routeSection="StratholmeGates2", areaType="Zone", area="Orgrimmar", },
	...
	[5057] = { id=5057, name="Past Endeavors", baseexp=4750, exp=0, qlvl=60, type="turnin", preQuests="5054,5055,5056", routes="Main,Strat,Solo", routePickup="wsEverlook", routeSection="wsEverlook", areaType="Zone", area="Winterspring", comments="There's conflicting info whether this is completed in Winterspring or in Thunderbluff" },
	...
	[5262] = { id=5262, name="The Truth Comes Crashing Down", baseexp=14300, exp=0, qlvl=60, type="turnin", routes="Strat", routePickup="EPLTown2", routeSection="EPLTown3", areaType="Dungeon", area="Stratholme", },
