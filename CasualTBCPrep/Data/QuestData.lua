...
local questsMetadata = {
	...
	[7163] = { name="Rise and Be Recognized", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1", reqAnyItem=1, preQuests="7161", reqRep=729, reqRepRank=5, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7164] = { name="Honored Amongst the Clan", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1,17905-1", reqAnyItem=1, preQuests="7161", reqRep=729, reqRepRank=6, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7165] = { name="Earned Reverence", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1,17905-1,17906-1", reqAnyItem=1, preQuests="7161", reqRep=729, reqRepRank=7, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=2, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7166] = { name="Legendary Heroes", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1,17905-1,17906-1,17907-1", reqAnyItem=1, preQuests="7161", reqRep=729, reqRepRank=8, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7167] = { name="Eye of Command", baseexp=0, qlvl=51, type="turnin", reqItems="17690-1,17905-1,17906-1", reqAnyItem=1, preQuests="7161", reqRep=729, reqRepRank=8, routes="Main,Strat,Solo", routePickup="AV", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
