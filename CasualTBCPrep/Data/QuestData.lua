...
local questsMetadata = {
	...
	[8181] = { id=8181, name="Confront Yeh'kinya", baseexp=9000, exp=0, qlvl=58, type="turnin", preQuests="3520,3527,4787,3528,5065", routes="Main,Strat,Solo", routeSection="TanarisPort", areaType="Zone", area="Tanaris", comments="Make sure everyone turns this in at the same time. After a delay, the NPC despawns. Respawn takes 1½-5min. It's worth waiting for the turnin+followup" },
	...
	[5511] = { id=5511, name="The Key to Scholomance", baseexp=14300, exp=0, qlvl=60, type="turnin", preQuests="5096,5098,838,964,5514,5802,5804", routes="Main,Strat,Solo", routeSection="WPLBulwark", areaType="Zone", area="Western Plaguelands", comments="Alliance quest starts a 20sec RP when turning in. Unsure if this is also true for horde, but the wait is short" },
	...
	[8283] = { id=8283, name="Wanted - Deathclasp, Terror of the Sands", baseexp=11600, exp=0, qlvl=59, type="turnin", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", comments="Has a short 2 min respawn timer. The quest is worth ~4½ minutes of SlavePens :) You can decide if you wanna wait or fight for a tag" },
	...
	[9232] = { id=9232, name="The Only Song I Know...", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="22682-2,7080-2,12361-2", preQuests="9033", routes="Main,Strat,Solo", routeSection="EPLTown", areaType="Raid", area="Naxxramas", comments="Requires Raiding Naxxramas. Is not included in the RXP guides" },
	[9230] = { id=9230, name="Ramaladni's Icy Grasp", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="22682-1,12361-1,12360-1", preQuests="9033,9229", routes="Main,Strat,Solo", routeSection="EPLTown", areaType="Raid", area="Naxxramas", comments="Requires Raiding Naxxramas. Is not included in the RXP guides" },
	...
	[8802] = { id=8802, name="The Savior of Kalimdor", baseexp=14300, exp=0, qlvl=60, type="qlog", reqItems="21221-1", preQuests="8801", routes="Main,Strat,Solo", routeSection="CavernsOfTime", areaType="Raid", area="Temple of Ahn'Qiraj", comments="Unlike other raid boss 'heads', The first quest from the item is turned in inside the raid, then the followup goes outside. Therefore it has to be a questlog quest" },
	[8301] = { id=8301, name="The Path of the Righteous", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20384-200", preQuests="8286,8288", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Blackwing Lair", },
	[8791] = { id=8791, name="The Fall of Ossirian", baseexp=14300, exp=0, qlvl=60, type="turnin", reqItems="21220-1", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8317] = { id=8317, name="Kitchen Assistance", baseexp=4350, exp=0, qlvl=57, type="turnin", reqItems="20452-10", preQuests="8307,8313", reqProf=185, reqProfSkill=285, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	...
	[8323] = { id=8323, name="True Believers", baseexp=9300, exp=0, qlvl=59, type="turnin", reqItems="20404-10", preQuests="8284,8285", routes="Main,Strat,Solo", routeSection="SilithusCave", areaType="Zone", area="Silithus", },
	[8318] = { id=8318, name="Secret Communication", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20404-10", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8361] = { id=8361, name="Abyssal Contacts", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20513-1", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8332] = { id=8332, name="Dukes of the Council", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20513-3,14344-1", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8341] = { id=8341, name="Lords of the Council", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20514-3,14344-5", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8348] = { id=8348, name="Signet of the Dukes", baseexp=11900, exp=0, qlvl=60, type="turnin", reqItems="20514-1", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8352] = { id=8352, name="Scepter of the Council", baseexp=14300, exp=0, qlvl=60, type="turnin", reqItems="20515-1", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[9248] = { id=9248, name="Humble Offering", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20515-1", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8711] = { id=8711, name="Blade of Eternal Justice", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20886-1,20869-2,20861-5,20865-5", playerClass="PALADIN", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8709] = { id=8709, name="Dagger of Veiled Shadows", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20886-1,20872-1,20859-5,20863-5", playerClass="ROGUE", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8706] = { id=8706, name="Hammer of the Gathering Storm", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20886-1,20869-2,20861-5,20865-5", playerClass="SHAMAN", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8712] = { id=8712, name="Scythe of the Unseen Path", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20886-1,20866-2,20860-5,20864-5", playerClass="HUNTER", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8558] = { id=8558, name="Sickle of Unyielding Strength", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20886-1,20873-2,20862-5,20858-5", playerClass="WARRIOR", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8707] = { id=8707, name="Blade of Vaulted Secrets", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20890-1,20871-2,20860-5,20864-5", playerClass="MAGE", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8705] = { id=8705, name="Gavel of Infinite Wisdom", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20890-1,20868-2,20861-5,20865-5", playerClass="PRIEST", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8710] = { id=8710, name="Kris of Unspoken Names", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20890-1,20867-2,20859-5,20863-5", playerClass="WARLOCK", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8708] = { id=8708, name="Mace of Unending Life", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20890-1,20870-2,20862-5,20858-5", playerClass="DRUID", reqRep=609, reqRepRank=8, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8693] = { id=8693, name="Cloak of Veiled Shadows", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20885-1,20866-2,20861-5,20865-5", playerClass="ROGUE", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8557] = { id=8557, name="Drape of Unyielding Strength", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20885-1,20867-2,20864-5,20860-5", playerClass="WARRIOR", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8691] = { id=8691, name="Drape of Vaulted Secrets", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20885-1,20873-2,20858-5,20862-5", playerClass="MAGE", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8689] = { id=8689, name="Shroud of Infinite Wisdom", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20885-1,20870-2,20859-5,20863-5", playerClass="PRIEST", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8694] = { id=8694, name="Shroud of Unspoken Names", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20889-1,20869-2,20861-5,20865-5", playerClass="WARLOCK", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8692] = { id=8692, name="Cloak of Unending Life", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20889-1,20872-2,20864-5,20860-5", playerClass="DRUID", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8696] = { id=8696, name="Cloak of the Unseen Path", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20889-1,20868-2,20858-5,20862-5", playerClass="HUNTER", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8690] = { id=8690, name="Cloak of the Gathering Storm", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20889-1,20871-2,20863-5,20859-5", playerClass="SHAMAN", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8695] = { id=8695, name="Cape of Eternal Justice", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20889-1,20871-2,20859-5,20863-5", playerClass="PALADIN", reqRep=609, reqRepRank=7, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8697] = { id=8697, name="Ring of Infinite Wisdom", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20888-1,20871-2,20860-5,20864-5", playerClass="PRIEST", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8702] = { id=8702, name="Ring of Unspoken Names", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20888-1,20870-2,20858-5,20862-5", playerClass="WARLOCK", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8701] = { id=8701, name="Band of Veiled Shadows", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20888-1,20867-2,20858-5,20862-5", playerClass="ROGUE", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8704] = { id=8704, name="Signet of the Unseen Path", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20888-1,20869-2,20859-5,20863-5", playerClass="HUNTER", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8699] = { id=8699, name="Band of Vaulted Secrets", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20884-1,20866-2,20859-5,20863-5", playerClass="MAGE", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8700] = { id=8700, name="Band of Unending Life", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20884-1,20873-2,20861-5,20865-5", playerClass="DRUID", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8698] = { id=8698, name="Ring of the Gathering Storm", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20884-1,20872-2,20860-5,20864-5", playerClass="SHAMAN", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8556] = { id=8556, name="Signet of Unyielding Strength", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20884-1,20868-2,20861-5,20865-5", playerClass="WARRIOR", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8703] = { id=8703, name="Ring of Eternal Justice", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="20884-1,20872-2,20860-5,20864-5", playerClass="PALADIN", reqRep=609, reqRepRank=6, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Raid", area="Ruins of Ahn'Qiraj", },
	[8183] = { id=8183, name="The Heart of Hakkar", baseexp=14300, exp=0, qlvl=60, type="turnin", reqItems="19802-1", routes="Main,Strat,Solo", routeSection="zgSTV", areaType="Raid", area="Zul'Gurub", comments="This starts a 1:30min RP, so turn in Hand of Rastahkan first, and try to have everyone turn this in at the same time, before the RP" },
	[8240] = { id=8240, name="A Bijou for Zanza", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="19708-1,19713-1,19715-1,19711-1,19710-1,19712-1,19707-1,19714-1,19709-1", reqAnyItem=1, routes="Main,Strat,Solo", routeSection="zgSTV", areaType="Zone", area="Stranglethorn Vale", comments="Needs 1 bijou of any type" },
	...
	[8331] = { id=8331, name="Aurel Goldleaf", baseexp=960, exp=0, qlvl=60, type="turnin", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8343] = { id=8343, name="Goldleaf's Discovery", baseexp=960, exp=0, qlvl=60, type="turnin", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8349] = { id=8349, name="Bor WIldmane", baseexp=960, exp=0, qlvl=60, type="turnin", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8351] = { id=8351, name="Bor Wishes to Speak", baseexp=960, exp=0, qlvl=60, type="turnin", routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[7163] = { id=7163, name="Rise and Be Recognized", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", reqRep=729, reqRepRank=5, routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7164] = { id=7164, name="Honored Amongst the Clan", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", reqRep=729, reqRepRank=6, routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=1, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7165] = { id=7165, name="Earned Reverence", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", reqRep=729, reqRepRank=7, routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=2, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7166] = { id=7166, name="Legendary Heroes", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", reqRep=729, reqRepRank=8, routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[7167] = { id=7167, name="Eye of Command", baseexp=0, exp=0, qlvl=51, type="turnin", preQuests="7161", reqRep=729, reqRepRank=8, routes="Main,Strat,Solo", routeSection="AV", areaType="Battleground", area="Alterac Valley", isScaling=true, scaleRank=3, comments="These AV quests apparently scale UP with level, unlike other quests. Verified from videos from last TBC" },
	[5051] = { id=5051, name="Two Halves Become One", baseexp=7900, exp=0, qlvl=54, type="turnin", preQuests="5021,5023,5049,5050", routes="Main,Strat,Solo", routeSection="WPLFelstoneField", areaType="Zone", area="Western Plaguelands", comments="On TBC release, check if the Jabbering Ghoul is up. If it is, this is free extra exp. If it's not up, you should skip this quest. " },
	...
	[5526] = { id=5526, name="Shards of the Felvine", baseexp=14300, exp=0, qlvl=60, type="turnin", reqItems="18501-1", preQuests="5527", routes="Main,Strat,Solo", routeSection="Moonglade", areaType="Zone", area="Moonglade", comments="You can collect the shard from Dire Maul without being on the quest. Loot the object on the ground" },
	...
	[1185] = { id=1185, name="Under the Chitin Was...", baseexp=4350, exp=0, qlvl=57, type="turnin", preQuests="1123,1124,1125", routes="Main,Strat,Solo", routeSection="Moonglade", areaType="Zone", area="Moonglade", },
	[8307] = { id=8307, name="Desert Recipe", baseexp=4350, exp=0, qlvl=57, type="turnin", reqProf=185, reqProfSkill=285, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8313] = { id=8313, name="Sharing the Knowledge", baseexp=8750, exp=0, qlvl=57, type="turnin", reqProf=185, reqProfSkill=285, routes="Main,Strat,Solo", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8315] = { id=8315, name="The Calling", baseexp=11900, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", comments="We will do this quest after turning in the prequests. In TBC, it becomes a 5-man quest instead of a raid. It's 12k exp + 9.5k free from the followup, it's worth spending some minutes" },
	[8316] = { id=8316, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="WARRIOR", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", comments="Requires doing \"The Calling\" on TBC release" },
	[8376] = { id=8376, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="PALADIN", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8377] = { id=8377, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="HUNTER", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8380] = { id=8380, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="SHAMAN", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8382] = { id=8382, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="DRUID", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8381] = { id=8381, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8379] = { id=8379, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="PRIEST", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	[8378] = { id=8378, name="Armaments of War", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="8304,8309,8310", playerClass="ROGUE", routes="Main,Strat", routeSection="SilithusHold2", areaType="Zone", area="Silithus", },
	...
	[5891] = { id=5891, name="Salve via Disenchanting", baseexp=6100, exp=0, qlvl=55, type="turnin", reqItems="11174-1", preQuests="4102", reqProf=333, reqProfSkill=205, routes="Main,Strat,Solo", routeSection="felwoodEmerald", areaType="Zone", area="Felwood", },
	...
	[5057] = { id=5057, name="Past Endeavors", baseexp=4750, exp=0, qlvl=60, type="turnin", preQuests="5054,5055,5056", routes="Main,Strat,Solo", routeSection="wsEverlook", areaType="Zone", area="Winterspring", comments="There's conflicting info whether this is completed in Winterspring or in Thunderbluff" },
	...
	[3570] = { id=3570, name="Seeping Corruption", baseexp=7350, exp=0, qlvl=52, type="turnin", preQuests="3568,3569", routes="Main,Strat,Solo", routeSection="Undercity", areaType="Zone", area="Undercity", },
	...
	[4941] = { id=4941, name="Eitrigg's Wisdom", baseexp=9550, exp=0, qlvl=60, type="turnin", preQuests="4903", routes="Main,Strat,Solo", routeSection="Orgrimmar", areaType="Dungeon", area="Badlands", comments="This quest is part of the Onyxia Attunement. The Onyxia head is better exp, as it unlocks 2x 14300 exp quests, but if you don't plan on getting it, this is available as an extra turnin. Make sure Warlord's Command is either in your questlog, or is completed" },
	...
	[3884] = { id=3884, name="Williden's Journal", baseexp=5100, exp=0, qlvl=50, type="turnin", reqItems="11116-1", routes="Main,Strat,Solo", routeSection="UngoroRefuge", areaType="Zone", area="Un'Goro Crater", comments="This quest gives very little XP. You can skip it, but it's included for completeness" },
	[2583] = { id=2583, name="A Boar's Vitality", baseexp=6800, exp=0, qlvl=50, type="turnin", reqItems="8392-3,8393-2,8394-1", routes="Main,Strat,Solo", routeSection="BlastedLands", areaType="Zone", area="Blasted Lands", comments="This quest gives very little XP. You can skip it, but it's included for completeness" },
	[2581] = { id=2581, name="Snickerfang Jowls", baseexp=6800, exp=0, qlvl=50, type="turnin", reqItems="8391-3,8392-2,8393-1", routes="Main,Strat,Solo", routeSection="BlastedLands", areaType="Zone", area="Blasted Lands", comments="This quest gives very little XP. You can skip it, but it's included for completeness" },
	...
	[3761] = { id=3761, name="Un'Goro Soil", baseexp=6800, exp=0, qlvl=50, type="turnin", reqItems="11018-20", routes="Main,Strat,Solo", routeSection="ThunderBluff", areaType="Zone", area="Thunder Bluff", comments="This quest gives very little XP. You can skip it, but it's included for completeness" },
	[4023] = { id=4023, name="A Taste of Flame", baseexp=7900, exp=0, qlvl=54, type="turnin", reqItems="10575-1", routes="Main,Strat", routeSection="BurningSteppes2", areaType="Zone", area="Burning Steppes", comments="This quest gives very little XP. You can skip it, but it's included for completeness" },
}
