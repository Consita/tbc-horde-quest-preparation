...
local questsMetadata = {
	...
	[5462] = { id=5462, name="The Dying, Ras Frostwhisper", baseexp=7150, exp=0, qlvl=60, type="turnin", reqItems="13544-1", preQuests="5382,5515,5384,5461", routes="Strat", routePickup="WPLCaerDarrow", routeSection="EPLTown2", areaType="Zone", area="Western Plaguelands", },
	...
	[6824] = { id=6824, name="Hands of the Enemy", baseexp=14300, exp=0, qlvl=60, type="qlog", reqItems="17332-1,17329-1,17331-1,17330-1", preQuests="6804,6805,6821,6822,6823", routes="Main,Strat", routeSection="BayOfStorms", areaType="Raid", area="The Molten Core", },
	[7486] = { id=7486, name="A Hero's Reward", baseexp=14300, exp=0, qlvl=60, type="turnin", preQuests="6804,6805,6821,6822,6823,6824", routes="Main,Strat", routePickup="BayOfStorms", routeSection="BayOfStorms", areaType="Raid", area="The Molten Core", },
	...
	[8947] = { id=8947, name="Anthion's Strange Request", baseexp=9550, exp=0, qlvl=60, type="turnin", reqItems="11371-3,12810-20,14342-3,15407-4", preQuests="OVERWRITTEN_IN_ADDON", routes="Strat", routePickup="StratholmeGates2", routeSection="StratholmeGates2", areaType="Zone", area="Orgrimmar", comments="This is the last Tier 0.5 quest done in the strat route, so you can skip it if it's too expensive. If you do Dire Maul after this step (this addon doesn't) the followup quest is turned in inside DM Lib." },
