...
local itemsMetadata = {
    ...
    [16672] = { id=16672, name="Gauntlets of Elements", rarity=3, stackSize=1, texture=132945, quests="8942", sources="Pyroguard Emberseer in Upper Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16673] = { id=16673, name="Cord of Elements", rarity=3, stackSize=1, texture=132505, quests="8942", sources="Random drop in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16676] = { id=16676, name="Beaststalker's Gloves", rarity=3, stackSize=1, texture=132944, quests="8938", sources="War Master Voone in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16680] = { id=16680, name="Beaststalker's Belt", rarity=3, stackSize=1, texture=132517, quests="8938", sources="Random drop in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16684] = { id=16684, name="Magister's Gloves", rarity=3, stackSize=1, texture=132951, quests="8939", sources="Doctor Theolen Krastinov in Scholomance", auctionHouse=true, inCompanionBag=true },
    [16685] = { id=16685, name="Magister's Belt", rarity=3, stackSize=1, texture=132497, quests="8939", sources="Random drop in LBRS or Stratholme", auctionHouse=true, inCompanionBag=true },
    [16692] = { id=16692, name="Devout Gloves", rarity=3, stackSize=1, texture=132948, quests="8940", sources="Archivist Galford in Stratholme Living", auctionHouse=true, inCompanionBag=true },
    [16696] = { id=16696, name="Devout Belt", rarity=3, stackSize=1, texture=132499, quests="8940", sources="Random drop in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16702] = { id=16702, name="Dreadmits Belt", rarity=3, stackSize=1, texture=132501, quests="8943", sources="Random drop in Stratholme", auctionHouse=true, inCompanionBag=true },
    [16705] = { id=16705, name="Dreadmist Wraps", rarity=3, stackSize=1, texture=132966, quests="8943", sources="Lorekeeper Polkelt or Necromancers in Scholomance", auctionHouse=true, inCompanionBag=true },
    [16712] = { id=16712, name="Shadowcraft Gloves", rarity=3, stackSize=1, texture=132958, quests="8941", sources="Shadow Hunter Vosh'gajin in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16713] = { id=16713, name="Shadowcraft Belt", rarity=3, stackSize=1, texture=132492, quests="8941", sources="Random drop in Lower Blackrock Spire", auctionHouse=true, inCompanionBag=true },
    [16716] = { id=16716, name="Wildheart Belt", rarity=3, stackSize=1, texture=132504, quests="8927", sources="Random drop in Lower Blackrock Spire or Scholomance", auctionHouse=true, inCompanionBag=true },
    [16717] = { id=16717, name="Wildheart Gloves", rarity=3, stackSize=1, texture=132951, quests="8927", sources="The Unforgiven in Stratholme", auctionHouse=true, inCompanionBag=true },
    [16723] = { id=16723, name="Lightforge Belt", rarity=3, stackSize=1, texture=132500, quests="10495", sources="Random drop in Stratholme", auctionHouse=true, inCompanionBag=true },
    [16724] = { id=16724, name="Lightforge Gauntlets", rarity=3, stackSize=1, texture=132953, quests="10495", sources="Timmy the Cruel in Stratholme Living", auctionHouse=true, inCompanionBag=true },
    [16736] = { id=16736, name="Belt of Valor", rarity=3, stackSize=1, texture=132523, quests="8944", sources="Smolderthorn Berserker in Lower Blackrock Spire, Patchwerk mobs in Stratholme Undead", auctionHouse=true, inCompanionBag=true },
    [16737] = { id=16737, name="Gauntlets of Valor", rarity=3, stackSize=1, texture=132960, quests="8944", sources="Ramstein the Gorger in Stratholme Undead", auctionHouse=true, inCompanionBag=true },
    ...
    [21939] = { id=21939, name="Fel Elemental Rod", rarity=1, stackSize=1, texture=135155, quests="8928", sources="Sold by Vi'el for 40g in Darkwhisper Gorge, Winterspring", auctionHouse=true },
