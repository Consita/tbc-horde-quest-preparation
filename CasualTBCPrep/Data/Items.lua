...
local itemsMetadata = {
    ...
    [10575] = { name="Black Dragonflight Molt", rarity=1, stackSize=10, texture=134430, quests="4022,4023", sources="Searing Gorge Quest or dropped by Burning Steppes elite summoned by Cyrus Therepentous. Used by either of the two Taste of Flame quests" },
